...
<div class="w3-bar w3-white w3-large">
    <a href="#" class="w3-bar-item w3-button w3-red w3-mobile"><i class="fa fa-bed w3-margin-right"></i>HM</a>
...
<div class="w3-content" style="max-width:1532px;">
    ...
    <div class="w3-row-padding" id="about">
        ...
        <div class="w3-col l8 12">
            ...
            <img src="resources/images/map.jpg" class="w3-image w3-greyscale" style="width:100%;">
        </div>
    </div>
